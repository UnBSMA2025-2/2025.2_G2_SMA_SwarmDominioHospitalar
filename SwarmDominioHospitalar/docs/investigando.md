...
| 8. Manter Rastreabilidade | Registro da base consultada, string utilizada, filtros aplicados e numero de retornos | String utilizada: ("multi-agent systems" OR "multiagent systems")  AND ("contagion simulation" OR "epidemic modeling" OR "disease spread" OR "contagion dynamics")  AND ("swarm" OR "swarm intelligence" OR "swarm behavior") <br> Resultados: 256 <br> Devido ao número de resultados e a quantidade de artigos após os critérios não achei necessária mudança na string de busca |
...
<p align="center"> 
  <strong>Fonte:</strong> <a href="https://github.com/PabloGJBS">Pablo Guilherme</a>
</p>
